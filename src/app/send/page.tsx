          ...
          >
            ...
            >
              <input
                ...
                className={`w-full rounded-md bg-black/40 border px-3 py-2.5 text-sm text-white placeholder:text-gray-500 focus:outline-none focus-visible:ring-2 ${
                  memoTone === "over"
                    ? "border-red-400/50 focus:border-red-300/70 focus-visible:ring-red-300/50"
                    : memoTone === "warn"
                      ? "border-amber-400/40 focus:border-amber-300/70 focus-visible:ring-amber-300/50"
                      : "border-white/10 focus:border-violet-300/60 focus-visible:ring-violet-300/50"
                }`}
              />
              {validation.memo && (
