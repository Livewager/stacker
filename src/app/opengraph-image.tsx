...
export const alt = "Dunk — tilt, pour, don't spill.";
    ...
    (
      <div
        style={{
          ...
          backgroundImage:
            "radial-gradient(1200px 700px at 10% 10%, rgba(34,211,238,0.22), rgba(2,11,24,0)), radial-gradient(900px 600px at 100% 100%, rgba(8,145,178,0.35), rgba(2,11,24,0))",
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          ...
          >
            <span style={{ display: "flex" }}>Tilt.</span>
            <span
              style={{
                display: "flex",
            ...
            <span style={{ display: "flex" }}>Don&apos;t spill.</span>
          </div>
          <div
            style={{
              fontSize: 28,
          ...
          >
            A 20-second skill game. Non-custodial points on the Internet
            Computer. ICRC-1 + ICRC-2 + ICRC-3.
          </div>
        </div>
